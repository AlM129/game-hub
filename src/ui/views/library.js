...
// LIBRARY VIEW
// ==========================================
// Renders the games library grid with search functionality
...
export async function renderLibrary(filterTerm = '') {
    ...
    const allWithData = getAllGamesWithPlayData(Storage);
